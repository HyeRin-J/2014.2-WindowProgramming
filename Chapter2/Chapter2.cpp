// Chapter2.cpp : 콘솔 응용 프로그램에 대한 진입점을 정의합니다.
//
...
int _tmain(int argc, TCHAR* argv[], TCHAR* envp[])
{
	...
	if (hModule != NULL)
	{
		...
		else
		{
			...
			_tprintf(_T("CString 최대 길이 : %d(INT_MAX)\n"), INT_MAX);
