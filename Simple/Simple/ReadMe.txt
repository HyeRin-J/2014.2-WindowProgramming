...
Simple.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CSimpleApp 응용 프로그램
    클래스를 선언합니다.

Simple.cpp
    응용 프로그램 클래스 CSimpleApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Simple.pch와
